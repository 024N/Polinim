...
public class OuterPostPojo {
        ...
        public OuterPostPojo() {
        }

        public OuterPostPojo(String questionID, String date, String time, String caregory, String question, User user, ImageInfo imageInfo) {
