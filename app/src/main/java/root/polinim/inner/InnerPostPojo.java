...
public class InnerPostPojo {
        ...
        public InnerPostPojo() {
        }

        public InnerPostPojo(String questionID, String date, String time, String caregory, String question, User user, ImageInfo imageInfo) {
